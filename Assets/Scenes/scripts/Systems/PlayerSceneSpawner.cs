...
public class PlayerSceneSpawner : MonoBehaviour
{
    ...
    {
        // If there is no PlayerSceneSpawner in the active scene, create one dynamically
        if (FindFirstObjectByType<PlayerSceneSpawner>() == null)
        {
            GameObject spawnerGO = new GameObject("PlayerSceneSpawner_AutoGenerated");
            spawnerGO.AddComponent<PlayerSceneSpawner>();
            Debug.Log("[PlayerSceneSpawner] Auto-generated PlayerSceneSpawner for scene load.");
        }
    }
